...
void initializeModuleFastAddressSanitizerLegacyPassPass(PassRegistry &);
void initializeASanGlobalsMetadataWrapperPassPass(PassRegistry &);
void initializeASanFastGlobalsMetadataWrapperPassPass(PassRegistry &);
void initializeAddressSanitizerLegacyPassPass(PassRegistry &);
void initializeFastAddressSanitizerLegacyPassPass(PassRegistry &);
...
void initializeFastSafeStackLegacyPassPass(PassRegistry&);
...
void initializeFastAddressPass(PassRegistry&);
